...
The `0.22.0` policy bundle runtime line makes local bundles executable. It does not add a remote policy registry, cryptographic signing, staged promotion workflow, or migration runner for older bundle schemas.
